...
const SideBar = () => {
  return (
    ...
    <div className='flex w-full xl:flex-col items-center justify-between xl:justify-center gap-y-10 bg-white/10 xl:bg-gradient-to-r from-indigo-500 via-purple-500 to-pink-500 px-4 md:px-40 xl:px-0 h-[70px] xl:h-max py-8 xl:rounded-xl backdrop-blur-sm'>

      <NavLink to='/'><FaHome className='cursor-pointer text-3xl xl:text-xl xl:hover:scale-150 transition duration-500 ease-in-out' /></NavLink>
